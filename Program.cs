    ...
    class DoublyLinkedList
    {
       ...
       // as the size variable stores the count of elements in the doubly linked list.
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\nRemoveLast method(): ");
            element = myList.removeLast();
            myList.display();
            Console.WriteLine("Size of list is " + myList.length());
            Console.WriteLine("Deleted tail node element is "+ element);

             Console.WriteLine("\nDelete element from any position by removeAny method.");
            element = myList.removeAny(2); // 3 is position
            myList.display();
            Console.WriteLine("Remove element is " + element);
            Console.WriteLine("Size of list is " + myList.length());
            ...
            //https://www.udemy.com/course/data-structures-and-algorithms-in-depth-using-c-sharp/learn/lecture/23205540#content
